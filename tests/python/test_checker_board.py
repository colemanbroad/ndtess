...
def test_tessellate_checkerboard_from_distmap_of_noise(load_synthetic):
    """
    run the tesselation on a labelled image where all objects have been identified already (null test)
    """

    img = load_synthetic['img']
    di = load_synthetic['distimg']
...
def test_tessellate_checkerboard_from_distmap_of_0_nonrowmajor(load_synthetic):
    """
    run the tesselation on a labelled image where all objects have been identified already (null test)
    """
...
def test_tessellate_checkerboard_from_distmap_of_noise_nonrowmajor(load_synthetic):
    """
    run the tesselation on a labelled image where all objects have been identified already (null test)
    """
...
def test_checkerboard_heapq_from_distmap_of_0(load_synthetic):
    """
    run the tesselation on a labelled image where all objects have been identified already (null test)
    """
...
def test_checkerboard_heapq_from_distmap_of_0_nonrowmajor(load_synthetic):
    """
    run the tesselation on a labelled image where all objects have been identified already (null test)
    """
...
def test_checkerboard_heapq_from_distmap_of_noise(load_synthetic):
    """
    run the tesselation on a labelled image where all objects have been identified already (null test)
    """
...
def test_checkerboard_heapq_from_distmap_of_noise_nonrowmajor(load_synthetic):
    """
    run the tesselation on a labelled image where all objects have been identified already (null test)
    """
